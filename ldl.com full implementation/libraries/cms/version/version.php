...
final class JVersion
{
	...
	public $COPYRIGHT = 'Copyright (C) 2004 - 2012 Kalika Computer Services, Inc. All rights reserved.';

	/** @var  string  Link text. */
	public $URL = '<a href="http://www.kalika.com.np">Kalika!</a> is a well known Computer, Electronics, Engineering, Accounting, Consulting organization.';
