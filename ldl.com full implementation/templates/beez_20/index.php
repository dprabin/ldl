<?php
/**
 * @package                Libra Digital Library
 * @subpackage		   com.stm.www
 * @copyright              Copyright (C) 2005 - 2014 Squad of Technical Minds P ltd. All rights reserved.
 * @license                GNU General Public License version 2 or later; for text and proprietary for books see LICENSE.txt
 */
                ...
                <div id="footer-outer">
                        ...
                        <div id="footer-sub">
                                ...
                                <div id="footer">
                                        ...
                                        <p>
                                                <?php echo JText::_('TPL_BEEZ2_POWERED_BY');?> <a href="http://cdpa.edu.np/">Squad of Technical Mind!&#174;</a>
                                        </p>
