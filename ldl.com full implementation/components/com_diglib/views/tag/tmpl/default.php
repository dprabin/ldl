...
<h1><?php echo $this->escape($this->tag->name); ?></h1>

<?php if($this->alldetails){ ?>
<h2>
	The library has <?php echo count($this->alldetails);?> 
	books having the tag <?php echo $this->escape($this->tag->name); ?>
</h2>
<ol>
...
<?php } else {?>
<h2>The library dosen't have any book with the tag <?php echo $this->escape($this->tag->name); ?></h2>
<?php }?>
