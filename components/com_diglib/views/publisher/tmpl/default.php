...
<h1><?php echo $this->escape($this->publisher->name); ?></h1>

<?php if($this->alldetails){ ?>
<h2>
	The library has <?php echo count($this->alldetails);?> 
	books from the publisher <?php echo $this->escape($this->publisher->name); ?>
</h2>
<ol>
...
<?php } else {?>
<h2>The library dosen't have any book published by <?php echo $this->escape($this->publisher->name); ?></h2>
<?php }?>
